      ...
      builder: (context, logsState) {
        return BlocBuilder<SettingsCubit, AppSettings>(
          builder: (context, settingsState) {
            final totalCigarettes = logsState.values.fold(0, (sum, count) => sum + count);
            final averagePerDay = logsState.isEmpty ? 0.0 : totalCigarettes / logsState.length;
                ...
                children: [
                  ...
                  Expanded(
                    child: _StatCard(
                      ...
                      value: '\$${spentUntilNow.toStringAsFixed(2)}',
